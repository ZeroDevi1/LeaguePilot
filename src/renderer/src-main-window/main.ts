...
try {
  ...
  console.error('LeaguePilot 无法正确加载：', error)
  alert(
    'LeaguePilot 无法正确加载，请查看控制台以获取更多信息 / LeaguePilot failed to load correctly, please check the console for more information'
  )
}
